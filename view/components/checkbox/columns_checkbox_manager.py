...
class ColumnsCheckboxManager(CheckboxManagerBase):
    ...
    def create_checkboxes_container(self, batch_size=50):
        ...
        self.paginator = Paginator(
            ...
            on_page_change_callback=lambda: self._refresh_checkboxes()
        )
    ...
    def _refresh_checkboxes(self):
        ...
        for i in range(0, len(paginated_values), 12):  # 12개씩 나누어 Row 생성
            ...
            for label, is_all_dup, is_selected in paginated_values[i:i + 12]:
                fill_color = ft.colors.LIGHT_BLUE if is_all_dup else None
